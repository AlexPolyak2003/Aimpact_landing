...
const VideoHeader = (): ReactElement => {
  ...
  return (
    <div className={color ? `${styles.wrapper} ${styles['wrapper-bg']}` : styles.wrapper}>
      <div className={color ? `${styles.content} ${styles['content-bg']}` : styles.content}>
        <Link to="logo" spy={true} smooth={true} duration={1000} className={styles.logo}>
