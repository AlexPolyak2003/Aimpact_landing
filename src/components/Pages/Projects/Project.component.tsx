          ...
          <div className={styles.blocks}>
            <div className={styles.first_block}>
              ...
              <p>
                ...
                корреляционный анализы, увеличила трафик в торговых точках на
                10% против целевых 5%
              </p>
            </div>
            ...
            <div className={styles.third_block}>
              ...
              <p>
                ...
                бондовых складов. Используя имитационное моделирование,
                выявлено: введение складов может увеличить продажи AliExpress на
                25% и снизить продажи конкурентов на 10-12%
              </p>
            </div>
